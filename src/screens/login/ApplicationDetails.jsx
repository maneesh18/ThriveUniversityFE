      ...
      <div className="application-content-wrapper">
        ...
        <div className="wrapper-2">
          <div>
            ...
            <div>
              You are guaranteed admission to Thrive University if you:
            </div>
          </div>
          <ul>
            <li>
        ...
        <div>  U.S. citizens or U.S. permanent residents applying for admission to
          UNT for the first time and who don't have any previous college credit
          should apply as freshmen.</div>
        </div>
      </div>
            ...
            <td colspan="3">
              <span class="tablesaw-cell-content">
                *You should apply and be admitted by March 1, 2023, to ensure
                that all high school records and entrance exams are current with
                Thrive University to be considered for the Thrive University
                Excellence Scholarship Award. Applications will continue to be
                accepted after the priority date.
              </span>
            </td>
          </tr>
        </tfoot>
