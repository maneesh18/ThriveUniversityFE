...
export const COURSE_LIST = [
  ...
  [
    ...
    },
    {
      ...
      shortForm: "IS",
      description:
        "A bachelor's degree in Information Science is the entry point for many information-related careers in the public and private sector. such as - Corporate researcher — working in management, software engineering, usability, intelligence analysis, web development and other areas, Data scientist — preserving and disseminating information in a timely manner to decision makers, Information analyst —finding, using, analyzing and synthesizing information from various sources, Information specialist — helping people find information and use it effectively, Knowledge manager —organizing information from multiple areas in a business to facilitate internal and external procedures.The bachelor's degree program is the portal to our master's degree in Information Science or Library Science. While pursuing your degree, you'll hone the skills required to Apply the latest information tools, Be an information professional, Organize, manage and analyze information",
      seats: 140,
    },
    {
